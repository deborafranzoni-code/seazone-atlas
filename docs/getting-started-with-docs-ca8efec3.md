<!-- title: Getting started with docs | url: https://outline.seazone.com.br/doc/getting-started-with-docs-j0VmR5ckto | area: Tecnologia -->

# Getting started with docs

<aside> 👋 This Docs template helps you organize your team's shared knowledge so you can all stay on the same page.
...
<aside> 📎 Learn more about Notion's database layouts, including when to use each type of database view in this guide: <https://www.notion.so/help/guides/when-to-use-each-type-of-database-view>.

<!-- title: BI de CS-RM ( Verificar doc e deletar - duplicado ) | url: https://outline.seazone.com.br/doc/bi-de-cs-rm-verificar-doc-e-deletar-duplicado-f5Exk33Riv | area: Tecnologia -->

# BI de CS-RM ( Verificar doc e deletar - duplicado )
...
* Preço Médio Ofertado:
  * Com o Sirius 2.0 podemos precificar uma mesma data de um mesmo listing diversas vezes. O último preço ofertado é a última precificação de uma data. Para datas reservadas é a precificação antes da reserva acontecer. O Preço Médio Ofertado só leva em conta datas **não bloqueadas**(dias disponíveis). Se houver algum Preço Médio Ofertado nulo, significa que naquele contexto não há datas disponíveis para o determinado listing/categoria/concorrente.
...
* Por que existem imóveis com alguns preços de diárias abaixo do preço mínimo?

  Isso acontece quando uma regra de preço mínimo foi criada após uma reserva já feita nas mesmas datas.

  Exemplo: o imóvel ABC123 recebeu uma reserva no dia 01/11/2023 para as datas entre 01/12/2023 e 10/12/2023 com preço médio de diária de R$400. No dia 5/11/2023 foi criada uma regra de preço mínimo de R$500 para este imóvel para o mês inteiro de dezembro. Então no gráfico de Preços Histórico/Futuro nas datas entre 01/12/2023 e 10/12/2023 o imóvel ABC123 estará com preço R$400 e preço mínimo R$500.
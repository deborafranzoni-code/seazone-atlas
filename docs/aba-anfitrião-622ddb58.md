<!-- title: Aba Anfitrião | url: https://outline.seazone.com.br/doc/aba-anfitriao-GGgJAarphh | area: Administrativo Financeiro -->
...
Importação de Dados via Script Anfitrião ⇒fechaAnfitriao()


1. Colunas: A/B/C/D/E/F/G/H/I/J/K
...
| Fechamento Mensal Template | Despesa Mes | B, C, D, E, H |
| Conciliação Reserva Sapron | Conciliação Fechamento | C, I |
| Conciliação Reserva Sapron | Limpezas Mes | C, D, F |
| 00 - Banco de dados PMS | Apartment | B, E, Q, AL |
| Relação Imóvel x Anfitrião | Relação 2.0 | A, B, C, F |
...
Planilha: <https://docs.google.com/spreadsheets/d/1W_a4KKvl-UKzH3ma5bzAWHG1amRPmEpVHfX-KqFmtBw/edit#gid=1582638460>


obs. esta aba é atualizada via script, sendo necessário aciona-lo pelo botão Import, que está no topo esquerdo da mesma aba


Treinamento: <https://www.loom.com/share/fbd55474ffd74dcdac62f1da1a4de8d0>
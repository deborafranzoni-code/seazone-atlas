<!-- title: Aba Modelo de Exportação - Props | url: https://outline.seazone.com.br/doc/aba-modelo-de-exportacao-props-USKnjFPCE5 | area: Administrativo Financeiro -->

# Aba Modelo de Exportação - Props

Importação de Dados via Script UpdateReservationPrp ⇒UpdateReservationsPrp()
...
| Conciliação Reserva Sapron | Conciliação Fechamento | B, C, D, E, F, J, P, Q |

<!-- title: Parceiros - Atualizar dados | url: https://outline.seazone.com.br/doc/parceiros-atualizar-dados-QKEYKqHlYp | area: Tecnologia -->

# Parceiros - Atualizar dados
...
```
 ...
 ![:warning:](https://a.slack-edge.com/production-standard-emoji-assets/14.0/google-medium/26a0-fe0f.png " =22x")
...
```
 ...
 ![:thinking_face:](https://a.slack-edge.com/production-standard-emoji-assets/14.0/google-medium/1f914.png " =22x")
